...
import { useExtensionContext } from "../../extension/context/ExtensionProvider";
...
const SearchExtension = ({ extensionType }: SearchExtensionProps) => {
    ...
    debounce(async (value: string) => {
      try {
        const response = await api.get(
          `/extension?type=${extensionType}&term=${value}`
        );
